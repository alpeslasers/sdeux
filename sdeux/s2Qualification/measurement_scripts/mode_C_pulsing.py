...
def execute_mode_C_measurement(s2, s2config, oscillo, powersupply, jura):
...
if __name__ == '__main__':
    ...
    with dms.acquire_instruments(s2_th, oscillo_th, ps_th, ju_th):
        ...
        try:
            ...
            oscillo.set_settings(channel=2, volt_scale_chan=3, offset_chan=0, chan_trig=2, time_scale=500e-3)
