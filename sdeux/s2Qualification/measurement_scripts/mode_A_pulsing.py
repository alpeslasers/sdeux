...
def execute_mode_A_measurement(s2, s2config, oscillo, powersupply, jura):
...
if __name__ == '__main__':
    ...
    with dms.acquire_instruments(s2_th, oscillo_th, ps_th, ju_th):
        ...
        try:
            ...
            s2config = dict(pulsing_mode='modeA', voltage=8, pulse_period=2000, pulse_width=1000,current_limit=20)
