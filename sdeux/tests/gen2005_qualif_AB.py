...
# S2Settings: pulse_period = 100, pulse_width = 100, output_voltage_set = 1.0, output_current_limit = 3.078125, pulsing_mode = 8, \
# bias_t = 0.0, burst_ON = 10, burst_OFF = 10, output_voltage_set_auto_high = 5.0, output_voltage_set_auto_low = 2.0, pulse_width_auto_high = 30,\
#                                                                 pulse_width_auto_low = 50, current_limit_mode = 0