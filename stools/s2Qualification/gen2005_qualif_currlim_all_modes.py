...
from stools.communication import RETRY_NO
from stools.defs import S2_STATUS_OK
...
# /home/local/olgare/.virtualenvs/scriptss2m/bin/python /home/local/olgare/PycharmProjects/scripts/elbit_scripts/s2Qualification/gen2005_qualif_currlim_all_modes_fast.py
# ******************** Configuring internal mode *************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
# Mode B
# Mode CSS
...
# AB_A Mode
# AB_B Mode
# >>>> Internal Mode Check: {'mode_internal_s2_status': 'overcurrent', 'mode_internal_s2_output_current_limit': 0.10000000149011612, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'ok', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode A *************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
...
# AB_A Mode
# AB_B Mode
# >>>> ModeA Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'overcurrent', 'modeA_s2_output_current_limit': 0.10000000149011612, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'ok', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode B *************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
...
# AB_A Mode
# AB_B Mode
# >>>> ModeB Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'overcurrent', 'modeB_s2_output_current_limit': 0.10000000149011612, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'ok', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode CSS *************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
# Mode B
...
# AB_A Mode
# AB_B Mode
# >>>> ModeCSS Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'overcurrent', 'modeCSS_s2_output_current_limit': 0.10000000149011612, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'ok', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode CST *************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
# Mode B
...
# AB_A Mode
# AB_B Mode
# >>>> ModeCST Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'overcurrent', 'modeCST_s2_output_current_limit': 0.10000000149011612, 'mode_AB_A_s2_status': 'ok', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode AB_limitA*************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
# Mode B
...
# AB_A Mode
# AB_B Mode
# >>>> AB_A Mode Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'overcurrent', 'mode_AB_A_s2_output_current_limit': 0.10000000149011612, 'mode_AB_B_s2_status': 'ok', 'mode_AB_B_s2_output_current_limit': 20.0}
# ******************** Configuring mode AB_limitB*************
# ******************** Checking overcurrent for all pulsing modes *************
# Internal Mode
# Mode A
# Mode B
...
# AB_A Mode
# AB_B Mode
# >>>> AB_B Mode Check: {'mode_internal_s2_status': 'ok', 'mode_internal_s2_output_current_limit': 20.0, 'modeA_status': 'ok', 'modeA_s2_output_current_limit': 20.0, 'modeB_status': 'ok', 'modeB_s2_output_current_limit': 20.0, 'modeCSS_status': 'ok', 'modeCSS_s2_output_current_limit': 20.0, 'modeCST_status': 'ok', 'modeCST_s2_output_current_limit': 20.0, 'mode_AB_A_s2_status': 'overcurrent', 'mode_AB_A_s2_output_current_limit': 20.0, 'mode_AB_B_s2_status': 'overcurrent', 'mode_AB_B_s2_output_current_limit': 0.10000000149011612}
# Execution time is: 23 min 38 sec
